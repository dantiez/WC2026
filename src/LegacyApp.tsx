        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="lg:hidden flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 min-w-11 min-h-11 text-text-muted hover:text-text-primary border border-border-default rounded-xl bg-surface-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400"
            >
